...
public class MainController {
    ...
    private static final List<String> MENU_LIST
    	= Arrays.asList("국밥","김밥","돈까스","떡볶이","삼겹살","초밥","치킨","햄버거","굶어라");
    // 랜덤 객체
    private static final Random RANDOM = new Random();
    
    // 0.05초 마다 동적하는 타임라인객체
    ...
    void buttonClick(ActionEvent event) {
    	//애니메이션 적용
    	// 0.05 초마다 바구다가 3되면 멈춰서도록  애니메이션 적용
    	timeline.stop();
    	stop.stop();
    ...
    public void updateManu() {
    	try {
    		...
    		// 이미지 변경
    		URL imgUrl = getClass().getResource("/img/icon.jpg");
    		if ( imgUrl == null ) {
